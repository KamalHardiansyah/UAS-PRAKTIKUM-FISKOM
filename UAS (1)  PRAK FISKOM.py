...
for i in range(0,10):
    Trapezoid(i+10,i+12,lambda x: x**3 - 4)

for i in range(0,10):
    Trapezoid(i+1,i+2,lambda x: x**2 - 10 )

for i in range(0,10):
    Trapezoid(i+5,i+12,lambda x: 6*x + 4)

for i in range(0,10):
    Trapezoid(i+1,i+2,lambda x: 8*x + 11)

for i in range(0,10):
    Trapezoid(i+2,i+3,lambda x: 7*x + 12)

for i in range(0,10):
    Trapezoid(i+1,i+5,lambda x: 11*x +2)

for i in range(0,10):
    Trapezoid(i+1,i+7,lambda x: 7*x+ 12)
